    ...
    <main className="min-h-screen bg-[#FAF9F6] px-5 py-10">
      <div className="mx-auto max-w-3xl rounded-[28px] border border-[rgba(0,0,0,0.06)] bg-white p-8 shadow-sm">
        ...
        <p className="mt-4 text-sm leading-6 text-[#6B7280]">
          These terms cover access to ClinicGrower Mission Control, account security,
          acceptable use, and service availability. Final legal copy should be
          reviewed by ClinicGrower before production launch.
        </p>
        <div className="mt-8 space-y-5 text-sm leading-6 text-[#3F3A45]">
          <section>
            ...
            <p>
              ...
              internal CRM data entered into the platform is accurate and lawfully held.
            </p>
          </section>
          <section>
            <h2 className="font-semibold text-[#111111]">Billing</h2>
            <p>
              Commercial terms for internal tooling, vendor services, or production
              hosting should be agreed with the ClinicGrower leadership team before launch.
            </p>
          </section>
          <section>
