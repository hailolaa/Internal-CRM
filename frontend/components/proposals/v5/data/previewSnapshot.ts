...
export const proposalV5PreviewPackages: GrowthPackageRecord[] = [
  ...
  makePackage({
    id: "clinic-growth-diagnostic",
    name: "Clinic Growth Diagnostic",
    priceCents: 39_500,
    billingFrequency: "one_off",
    setupFeeCents: 0,
    includedFeatures: ["Verified Clinic Growth Score", "Revenue leakage diagnosis", "Recommended 90-day plan"],
    proposalWording: "Clinic Growth Diagnostic unlocks the verified Clinic Growth Score, identifies revenue leakage and provides the recommended 90-day plan.",
    mediaSpendHandling: "Media spend is separate from the ClinicGrower fee.",
    sortOrder: 20,
    scopeItems: [
      scopeItem({
        category: "Diagnosis",
        title: "Verified diagnostic and 90-day plan",
        description: "Unlock the verified Clinic Growth Score, diagnose revenue leakage and create the recommended 90-day plan.",
        frequency: "One-off",
        ...
        exclusion: "Monthly programme delivery, managed media and custom reporting builds",
  ...
  makePackage({
    ...
    setupFeeCents: 49_500,
    includedFeatures: ["One location", "One active treatment", "One principal acquisition channel", "One conversion journey"],
    proposalWording: "Treatment Growth proves measurable growth on one priority treatment.",
    mediaSpendHandling: "Agreed ad spend is separate and paid directly to the selected platform with no ClinicGrower markup.",
    sortOrder: 30,
    scopeItems: [
      scopeItem({
        category: "Treatment Growth",
        title: "One priority treatment pathway",
        description: "Prove measurable growth on one priority treatment, one principal acquisition channel and one conversion journey.",
        frequency: "Monthly with weekly exceptions",
        quantityLimit: "One active treatment priority",
        treatmentsAndLocations: "One location and selected priority treatment",
        ...
        exclusion: "Whole-clinic direction, multiple acquisition channels and multi-location delivery",
        thirdPartyCosts: "Paid media and third-party tools remain separate.",
        sortOrder: 10,
      }),
    ],
  ...
  makePackage({
    ...
    includedFeatures: ["One location", "Up to three active treatment priorities", "Up to two coordinated acquisition channels", "Repeatable clinic growth system"],
    proposalWording: "Clinic Growth turns one successful treatment pathway into a repeatable clinic growth system.",
    ...
    scopeItems: [
      scopeItem({
        ...
        title: "Repeatable clinic growth system",
        description: "Turn one successful treatment pathway into a repeatable clinic growth system across approved priorities.",
        frequency: "90-day implementation, weekly exceptions and monthly strategy",
        quantityLimit: "Up to three active treatment priorities",
        treatmentsAndLocations: "One location and up to three active treatment priorities",
        ...
        exclusion: "Multi-location delivery, whole-group requirements and unapproved service lines",
  ...
  makePackage({
    ...
    priceCents: 349_500,
    billingFrequency: "monthly",
    setupFeeCents: 149_500,
    includedFeatures: ["One location", "Whole-clinic direction", "Up to six active treatment priorities", "Multi-channel growth"],
    proposalWording: "Market Leader builds the clinic patients recognise, trust and choose first.",
    mediaSpendHandling: "Agreed ad spend is separate and paid directly to the selected platform with no ClinicGrower markup.",
    sortOrder: 50,
    scopeItems: [
      scopeItem({
        ...
        quantityLimit: "Up to six active treatment priorities",
        treatmentsAndLocations: "One location, whole-clinic direction and up to six active treatment priorities",
        ...
        exclusion: "Multi-location/group requirements, unapproved markets, third-party tools and media spend",
        thirdPartyCosts: "Selected platform media and third-party tools remain separate.",
        sortOrder: 10,
      }),
    ],
...
function selectedPackage(packageId: string | null | undefined): GrowthPackageRecord {
  ...
  return (
    ...
    proposalV5PreviewPackages.find((item) => item.id === "clinic-growth") ||
...
function proofAssetsFor(clinicType: ProposalV5ClinicTypeId, longContent: boolean): ProposalProofAssetRecord[] {
  ...
  return [
    ...
    },
    {
      ...
      mediaUrl: "/brand/proposal/v5-reference/tanja-testimonial.jpg",
      sectorTags: [
        tag,
        "state:known",
    ...
    {
      id: `${clinicType}-dreamamed-001`,
      type: "performance_result",
      title: "DREAMAMED +163%",
      copy: "Lead conversions increased by 163%. Period not published.",
      mediaUrl: null,
      sectorTags: [
        tag,
        "clinic",
    ...
    {
      id: `${clinicType}-mediskin-001`,
      type: "performance_result",
      title: "MEDISKIN +205%",
      copy: "Conversions increased by 205% between January and May 2024.",
      mediaUrl: null,
      sectorTags: [
        tag,
        "clinic",
...
function sectionForPreview(clinicType: ProposalV5ClinicTypeId, fixture: ClinicFixture, longContent: boolean): ProposalSectionContent {
  ...
  return {
    ...
    termsSummary: "Monthly fee plus VAT, setup plus VAT where selected, media spend separate, six-month minimum term and 90-day notice after the initial term.",
