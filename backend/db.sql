...
-- Mission Control seed intentionally leaves legacy appointment rows empty.
...
CREATE TABLE `client_account_profile` (
  ...
  `google_drive_folder_url` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `google_drive_folder_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `google_drive_folder_access_status` enum('not_checked','accessible','inaccessible') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_checked',
  `google_drive_folder_error` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `google_drive_folder_checked_at` datetime DEFAULT NULL,
  `created_by` char(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `idx_client_account_profile_drive_folder` (`clinic_id`,`google_drive_folder_id`),
...
-- Mission Control seed intentionally leaves legacy clinical_note rows empty.
...
-- Mission Control seed intentionally leaves legacy consent rows empty.
...
-- Mission Control seed intentionally leaves legacy consult_template rows empty.
...
CREATE TABLE `contact` (
  ...
  `contact_role` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `communication_permissions` json DEFAULT NULL,
  `first_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `last_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `phone` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `role_title` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email_permission` tinyint(1) DEFAULT '1',
  `phone_permission` tinyint(1) DEFAULT '1',
  `sms_permission` tinyint(1) DEFAULT '0',
  `whatsapp_permission` tinyint(1) DEFAULT '0',
  `website` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  KEY `idx_contact_account_name` (`clinic_id`,`account_name`),
  KEY `idx_contact_website` (`clinic_id`,`website`),
...
-- Mission Control seed intentionally leaves legacy dashboard rows empty.
...
CREATE TABLE `proposal` (
  ...
  `template_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'clinicgrower_standard',
  ...
  KEY `idx_proposal_template` (`clinic_id`,`template_key`),
  KEY `idx_proposal_recommended_package` (`clinic_id`,`recommended_package_id`),
  KEY `fk_proposal_owner` (`owner_id`),
...
-- Mission Control seed intentionally leaves legacy document rows empty.
...
-- Mission Control seed intentionally leaves external integration credential rows empty.
...
('perm-proposals-read','proposals:read','Read internal proposals','2026-07-20 00:00:00','2026-07-20 00:00:00',NULL),
('perm-proposals-write','proposals:write','Create and update internal proposals','2026-07-20 00:00:00','2026-07-20 00:00:00',NULL),
...
-- Mission Control seed intentionally leaves legacy review rows empty.
...
('role-admin','perm-proposals-read','2026-07-20 00:00:00'),
('role-admin','perm-proposals-write','2026-07-20 00:00:00'),
...
('role-sales','perm-proposals-read','2026-07-20 00:00:00'),
('role-sales','perm-proposals-write','2026-07-20 00:00:00'),
...
('role-delivery','perm-proposals-read','2026-07-20 00:00:00'),
...
('role-finance','perm-proposals-read','2026-07-20 00:00:00'),
...
('role-internal-viewer','perm-proposals-read','2026-07-20 00:00:00'),
...
('role-clinic-admin','perm-proposals-read','2026-07-20 00:00:00'),
('role-clinic-admin','perm-proposals-write','2026-07-20 00:00:00'),
...
DROP TABLE IF EXISTS `task_comment_mention`;
...
INSERT INTO `user` VALUES ('user-001','clinic-001','admin@thegrowthgroup.com','$2b$12$8NKtY/GApbOgBzN0MKuKfOQl/j7XNtNnDF/sfMnGwNvBIc86vgnQu','Sarah','Johnson','07700 900001','SUPER_ADMIN',0,NULL,NULL,'2026-04-24 13:22:11',0,NULL,'active',1,NULL,'2026-04-24 13:22:11','2026-04-24 13:22:11',NULL),('user-002','clinic-001','sales@thegrowthgroup.com','$2b$12$hash2','James','Smith','07700 900002','SALES',0,NULL,NULL,NULL,0,NULL,'active',1,NULL,'2026-04-24 13:22:11','2026-04-24 13:22:11',NULL),('user-003','clinic-001','delivery@thegrowthgroup.com','$2b$12$hash3','Emma','Brown','07700 900003','DELIVERY',0,NULL,NULL,NULL,0,NULL,'active',1,NULL,'2026-04-24 13:22:11','2026-04-24 13:22:11',NULL),('user-004','clinic-002','admin.sales@thegrowthgroup.com','$2b$12$hash4','Michael','Wilson','07700 900004','SUPER_ADMIN',0,NULL,NULL,NULL,0,NULL,'active',1,NULL,'2026-04-24 13:22:11','2026-04-24 13:22:11',NULL),('user-005','clinic-002','ads@thegrowthgroup.com','$2b$12$hash5','Lisa','Davis','07700 900005','SALES',0,NULL,NULL,NULL,0,NULL,'active',1,NULL,'2026-04-24 13:22:11','2026-04-24 13:22:11',NULL),('user-006','clinic-003','delivery.lead@thegrowthgroup.com','$2b$12$hash6','Robert','Miller','07700 900006','ADMIN',0,NULL,NULL,NULL,0,NULL,'active',1,NULL,'2026-04-24 13:22:11','2026-04-24 13:22:11',NULL),('user-007','clinic-003','web@thegrowthgroup.com','$2b$12$hash7','Jennifer','Taylor','07700 900007','DELIVERY',0,NULL,NULL,NULL,0,NULL,'active',1,NULL,'2026-04-24 13:22:11','2026-04-24 13:22:11',NULL),('user-008','clinic-004','seo@thegrowthgroup.com','$2b$12$hash8','David','Anderson','07700 900008','SUPER_ADMIN',0,NULL,NULL,NULL,0,NULL,'active',1,NULL,'2026-04-24 13:22:11','2026-04-24 13:22:11',NULL),('user-009','clinic-004','success@thegrowthgroup.com','$2b$12$hash9','Sophie','Thomas','07700 900009','DELIVERY',0,NULL,NULL,NULL,0,NULL,'active',1,NULL,'2026-04-24 13:22:11','2026-04-24 13:22:11',NULL),('user-010','clinic-005','reports@thegrowthgroup.com','$2b$12$hash10','Christopher','Jackson','07700 900010','SUPER_ADMIN',0,NULL,NULL,NULL,0,NULL,'active',1,NULL,'2026-04-24 13:22:11','2026-04-24 13:22:11',NULL);
