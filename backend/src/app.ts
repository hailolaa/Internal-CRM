...
import landingPageLeadsRoutes from "./modules/landing-page-leads/landing-page-leads.routes.js";
...
import directDebitRoutes from "./modules/direct-debit/direct-debit.routes.js";
...
import clientOperatingRegisterRoutes from "./modules/client-operating-register/client-operating-register.routes.js";
...
import serviceAgreementsRoutes from "./modules/service-agreements/service-agreements.routes.js";
...
app.use("/api/public/landing-page-leads", landingPageLeadsRoutes);
...
app.use("/api/client-operating-register", clientOperatingRegisterRoutes);
...
app.use("/api/service-agreements", serviceAgreementsRoutes);
