...
export const config = {
    ...
    observability: {
        ...
        alertMaxAttempts: parseInt(process.env.OBSERVABILITY_ALERT_MAX_ATTEMPTS || "3", 10),
        alertRetryBaseDelayMs: parseInt(process.env.OBSERVABILITY_ALERT_RETRY_BASE_DELAY_MS || "250", 10),
        alertDedupeWindowMs: parseInt(process.env.OBSERVABILITY_ALERT_DEDUPE_WINDOW_MS || "300000", 10),
        alertRateLimitPerMinute: parseInt(process.env.OBSERVABILITY_ALERT_RATE_LIMIT_PER_MINUTE || "60", 10),
