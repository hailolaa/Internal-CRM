...
export class ContactsService {
  ...
  async updateContactProfile(
    ...
    addField("convertingSource", "converting_source", normalized.convertingSource);
    addField("utmSource", "utm_source", normalized.utmSource);
    addField("utmMedium", "utm_medium", normalized.utmMedium);
    addField("utmCampaign", "utm_campaign", normalized.utmCampaign);
    addField("utmContent", "utm_content", normalized.utmContent);
    addField("utmTerm", "utm_term", normalized.utmTerm);
    addField("landingPage", "landing_page", normalized.landingPage);
    addField("referrer", "referrer", normalized.referrer);
    addField("formSubmitted", "form_submitted", normalized.formSubmitted);
    addField("pageSubmitted", "page_submitted", normalized.pageSubmitted);
    addField("ctaClicked", "cta_clicked", normalized.ctaClicked);
    addField("gclid", "gclid", normalized.gclid);
    addField("fbclid", "fbclid", normalized.fbclid);
    addField("msclkid", "msclkid", normalized.msclkid);
    addField("ttclid", "ttclid", normalized.ttclid);
    addField("gbraid", "gbraid", normalized.gbraid);
    addField("wbraid", "wbraid", normalized.wbraid);
